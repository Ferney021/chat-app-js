...
const vm = new Vue ({
  ...
  async created () {
    ...
    this.addNotification(`Par de llaves generadas - ${this.getKeySnippet(this.originPublicKey)}`)
  ...
  methods: {
    ...
    setupSocketListeners () {
      ...
      this.socket.on('MESSAGE', async (message) => {
        ...
        if (message.recipient.e === this.originPublicKey.e && message.recipient.n === this.originPublicKey.n) {
      ...
      this.socket.on('ROOM_FULL', () => {
        this.addNotification(`No se ha podido entrar a la sala ${this.pendingRoom}, la sala esta llena.`)
